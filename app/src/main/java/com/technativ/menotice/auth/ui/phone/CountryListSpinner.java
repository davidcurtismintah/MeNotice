...
public final class CountryListSpinner extends AppCompatEditText implements
    ...
    private com.technativ.menotice.auth.ui.phone.CountryListAdapter countryListAdapter;
    ...
    private void init() {
        ...
        countryListAdapter = new com.technativ.menotice.auth.ui.phone.CountryListAdapter(getContext());
    ...
    @Override
    public void onLoadComplete(List<com.technativ.menotice.auth.ui.phone.CountryInfo> result) {
    ...
    public class DialogPopup implements DialogInterface.OnClickListener {
        ...
        private final com.technativ.menotice.auth.ui.phone.CountryListAdapter listAdapter;
        private AlertDialog dialog;

        DialogPopup(com.technativ.menotice.auth.ui.phone.CountryListAdapter adapter) {
            listAdapter = adapter;
        }
        ...
        public void onClick(DialogInterface dialog, int which) {
            final com.technativ.menotice.auth.ui.phone.CountryInfo countryInfo = listAdapter.getItem(which);
