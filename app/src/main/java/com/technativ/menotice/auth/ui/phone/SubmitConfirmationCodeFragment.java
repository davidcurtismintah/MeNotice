...
import com.technativ.menotice.auth.ui.TermsTextView;

/**
 * Display confirmation code to verify phone numbers input in {{@link VerifyPhoneNumberFragment}}
 */

public class SubmitConfirmationCodeFragment extends com.technativ.menotice.auth.ui.FragmentBase {
    ...
    public static SubmitConfirmationCodeFragment newInstance(FlowParameters flowParameters,
        ...
        args.putParcelable(com.technativ.menotice.auth.ui.ExtraConstants.EXTRA_FLOW_PARAMS, flowParameters);
        args.putString(com.technativ.menotice.auth.ui.ExtraConstants.EXTRA_PHONE, phoneNumber);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        View v = inflater.inflate(R.layout.auth_fragment_confirmation_code, container, false);
        ...
        final String phoneNumber = getArguments().getString(com.technativ.menotice.auth.ui.ExtraConstants.EXTRA_PHONE);
