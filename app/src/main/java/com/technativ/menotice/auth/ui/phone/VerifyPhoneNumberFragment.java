...
import com.technativ.menotice.auth.util.GoogleApiHelper;
...
public class VerifyPhoneNumberFragment extends FragmentBase implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        View v = inflater.inflate(R.layout.auth_fragment_verify_phone, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && !savedInstanceState.isEmpty()) {
            isShowingHint = savedInstanceState.getBoolean(ExtraConstants.EXTRA_IS_SHOWING_HINT);
        }
    ...
    void showHint() {
        ...
        if (mHelper.getFlowParams().enableHints) {
        ...
        if (requestCode == RC_PHONE_HINT) {
            if (data != null) {
                ...
                if (cred != null) {
                    ...
                    final String formattedPhone = PhoneNumberUtils
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(ExtraConstants.EXTRA_IS_SHOWING_HINT, isShowingHint);
    }
